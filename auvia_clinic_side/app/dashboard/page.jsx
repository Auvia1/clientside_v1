...
// import {
//   Calendar, PhoneCall, Activity, TrendingUp,
...
//   {
//     time: "2 mins ago",
//     title: "Virtual Agent handled a rescheduling request.",
//     meta: "Moved B. Nagarjuna to Thursday 2PM.",
//     dot: "bg-emerald-400",
//   },
//   {
//     time: "14 mins ago",
//     title: "Receptionist checked in K. Sai Pallavi.",
//     meta: "Front Desk",
//     dot: "bg-sky-400",
//   },
//   {
//     time: "25 mins ago",
//     title: "Missed Call: Unknown Number",
//     meta: "Return Call",
//     dot: "bg-amber-400",
//   },
//   {
//     time: "1 hour ago",
//     title: "Dr. Rao completed clinical notes for Patient #4421.",
//     meta: "Records Updated",
//     dot: "bg-violet-400",
//   },
// ];
...
//                         <span className={`mt-1 h-2 w-2 rounded-full shrink-0 ${item.dot}`} />
//                         <div>
...
//             {/* ── STATIC: Agent Performance ── */}
//             <Card className="border-0 bg-slate-900 text-white shadow-sm transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-md">
//               <CardHeader className="flex flex-row items-center justify-between">
//                 <div>
//                   <p className="text-[11px] uppercase tracking-[0.2em] text-slate-400">
//                     Auvia Agent Performance
//                   </p>
//                   <h2 className="mt-2 text-2xl font-semibold">
//                     12.4x <span className="text-xs text-sky-300">ROI Ratio</span>
//                   </h2>
//                 </div>
//                 <TrendingUp className="h-5 w-5 text-sky-300" />
//               </CardHeader>
//               <CardContent>
//                 <p className="text-xs text-slate-400">Missed Call Recovery</p>
//                 <div className="mt-3 h-2 rounded-full bg-slate-800">
//                   <div className="h-2 w-[78%] rounded-full bg-sky-400" />
//                 </div>
//                 <div className="mt-4 flex items-center justify-between text-xs text-slate-300">
//                   <span>₹2,840 recovered this month</span>
...
function useLiveActivity() {
  ...
  function connect() {
    ...
    const ws = new WebSocket(`${proto}://localhost:4002/ws/activity`);
    wsRef.current = ws;
