...
export async function GET(req, { params }) {
  ...
  try {
    ...
    if (searchParams.has("status")) queryString.set("status", searchParams.get("status"));
    ...
    const url = `${BACKEND_URL}/api/credits/payments/${clinic_id}?${queryString}`;
    ...
    console.error("Credit payments proxy error:", error);
