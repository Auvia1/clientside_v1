...
// Drop-in replacement for the WeekView component in app/schedule/page.jsx
// Matches the exact same grid + AppointmentCell style as the All Doctors view.
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border p-3 ${
                    isToday ? "border-emerald-300 bg-emerald-50" : "border-slate-100 bg-white"
                  }`}
                >
                  {/* Avatar + day label — mirrors All Doctors card */}
                  <div className="flex items-center gap-2">
                    <div
