...
//     console.log("Prev Day clicked:", { anchorDate, newDate });
...
//     d.setDate(d.getDate() + 1);
//     const newDate = d.toISOString().slice(0, 10);
//     console.log("Next Day clicked:", { anchorDate, newDate });
//     onDateChange(newDate);
//   };

//   const handleToday = () => {
//     const todayDate = new Date().toISOString().slice(0, 10);
//     console.log("Today clicked:", todayDate);
...
//               variant="outline"
//               size="sm"
//               className="rounded-full px-2 h-7 text-[11px]"
//               onClick={handleToday}
//             >
//               Today
//             </Button>
...
//                           viewMode === "week" ? "bg-slate-100 text-emerald-600 font-semibold" : "text-slate-700"
//                         }`}
//                       >
...
//                         }}
//                         className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-slate-50 transition-colors ${
//                           viewMode === "day" ? "bg-slate-100 text-emerald-600 font-semibold" : "text-slate-700"
//                         }`}
//                       >
...
//                         }}
//                         className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-slate-50 transition-colors ${
//                           viewMode === "month" ? "bg-slate-100 text-emerald-600 font-semibold" : "text-slate-700"
//                         }`}
//                       >
...
//               <CardContent>
//                 {/* View selection - week, day, or month */}
//                 {loading ? (
