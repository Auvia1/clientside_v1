...
export function Footer() {
  const footerLinks = {
    ...
    Resources: ["Docs", "Support", "Community", "Contact", "Status"],
    ...
    <footer className="border-t border-slate-200 bg-white px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-slate-900">Auvia Labs</span>
            </div>
        ...
        <div className="mt-12 border-t border-slate-200 pt-8 text-center">
          <p className="text-sm text-slate-600">© 2026 Auvia Labs. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
